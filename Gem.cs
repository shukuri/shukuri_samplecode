...
public class Gem : MonoBehaviour
{
    ...
    public float m_brake = 0.9f; //散らばる時の原則量、数値が小さいほど素早い

    private Vector3 m_direction; //散らばる方向の進行方向
    private float m_speed; //散らばる時の速さ
    public float m_followAccel = 0.01f;
    private bool m_isFollow; //プレイヤーを追尾するモードに入ったらtrue
    private float m_followSpeed; //プレイヤーを追尾する速さ
    public AudioClip m_goldClip;//宝石を取得したときの音
    ...
    private void Update()
    {
        ...
        //プレイヤーを追尾するモードに入っている場合かつプレイヤーがまだ死亡していない場合
